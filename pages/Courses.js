...
export default function Courses() {
  ...
  return (
      ...
      <MainHeader title="Courses" />
	    <section className="flex flex-col w-full h-full px-0 md:px-32 py-32 bg-neutral-300 dark:bg-slate-700">
	    	<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 bg-neutral-100 dark:bg-slate-800 pt-20">
