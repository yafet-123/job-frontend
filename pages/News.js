...
export default function News() {
  ...
  return (
    <React.Fragment>
      ...
      <section className="flex flex-col w-full h-full bg-white dark:!bg-slate-700 py-32">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-center text-3xl lg:text-7xl font-bold my-10 italic">Latest News</h1>
          <Slider {...settings}>
