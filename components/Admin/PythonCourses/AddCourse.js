...
export function AddCourse() {
    ...
    async function registercourse(e){
        e.preventDefault()
        setLoading(true)
        const data = await axios.post(`../api/addpythoncourse`,{
            "title": title,
            "content":content,
    ...
    return (
        <div className="px-0 lg:px-10 pt-20">
            <form className="max-w-7xl mx-auto mt-10" onSubmit={registercourse}>
                <h1 className="text-black dark:text-white text-xl lg:text-4xl font-bold text-center italic">Python Course</h1>
